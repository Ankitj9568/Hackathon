          ...
          <div className="footer11-newsletter">
            ...
            <div className="footer11-actions">
              <div className="footer11-form">
                ...
                <button className="thq-button-outline footer11-button">
                  <span>
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer11-text11 thq-body-small">
                          Subscribe
                        </span>
                      </Fragment>
                    )}
              ...
              <span>
                {props.content2 ?? (
                  <Fragment>
                    <span className="footer11-text20 thq-body-small">
          ...
          <div className="footer11-links">
            <div className="footer11-column1">
              <strong>
                {props.column1Title ?? (
                  <Fragment>
                    <strong className="footer11-text22 thq-body-large">
                      Column One
                    </strong>
                  </Fragment>
                )}
              ...
              <div className="footer11-footer-links1">
                ...
                >
                  {props.link1 ?? (
                    <Fragment>
                      <span className="footer11-text17 thq-body-small">
                        Link 1
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link2 ?? (
                    <Fragment>
                      <span className="footer11-text12 thq-body-small">
                        Link 2
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link3 ?? (
                    <Fragment>
                      <span className="footer11-text13 thq-body-small">
                        Link 3
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link4 ?? (
                    <Fragment>
                      <span className="footer11-text25 thq-body-small">
                        Link 4
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer11-text28 thq-body-small">
                        Link 5
                      </span>
                    </Fragment>
                  )}
            ...
            <div className="footer11-column2">
              <strong>
                {props.column2Title ?? (
                  <Fragment>
                    <strong className="footer11-text10 thq-body-large">
                      Column Two
                    </strong>
                  </Fragment>
                )}
              ...
              <div className="footer11-footer-links2">
                ...
                >
                  {props.link6 ?? (
                    <Fragment>
                      <span className="footer11-text14 thq-body-small">
                        Link 6
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer11-text26 thq-body-small">
                        Link 7
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link8 ?? (
                    <Fragment>
                      <span className="footer11-text16 thq-body-small">
                        Link 8
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer11-text21 thq-body-small">
                        Link 9
                      </span>
                    </Fragment>
                  )}
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer11-text24 thq-body-small">
                        Link 10
                      </span>
                    </Fragment>
                  )}
            ...
            <div className="footer11-column3">
              <strong>
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <strong className="footer11-text18 thq-body-large">
                      Follow Us
                    </strong>
                  </Fragment>
                )}
        ...
        <div className="footer11-credits">
          ...
          <div className="footer11-row">
            <span>
              {props.content3 ?? (
                <Fragment>
                  <span className="footer11-text15 thq-body-small">
                    © 2024 TeleportHQ
                  </span>
                </Fragment>
              )}
            ...
            <div className="footer11-footer-links3">
              <span>
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer11-text23 thq-body-small">
                      Privacy Policy
                    </span>
                  </Fragment>
                )}
              ...
              <span>
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer11-text19 thq-body-small">
                      Terms of Service
                    </span>
                  </Fragment>
                )}
              ...
              <span>
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer11-text27 thq-body-small">
                      Cookies Settings
                    </span>
                  </Fragment>
                )}
