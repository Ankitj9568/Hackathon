...
const SignIn3 = (props) => {
  return (
    <div className="sign-in3-container1 thq-section-padding">
      <div className="sign-in3-max-width thq-section-padding thq-section-max-width">
        <div className="sign-in3-form-root">
          <h2>
            {props.heading1 ?? (
              <Fragment>
                <h2 className="sign-in3-text18 thq-heading-2">User Sign in</h2>
              </Fragment>
            )}
          </h2>
            ...
            <div className="sign-in3-container3">
              ...
              >
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="sign-in3-text17 thq-body-small">
                        Sign in
                      </span>
                    </Fragment>
                  )}
        ...
        <div className="sign-in3-container4">
          <div className="sign-in3-divider1">
            ...
            <p>
              {props.content1 ?? (
                <Fragment>
                  <p className="sign-in3-text20 thq-body-large">
          ...
          <button type="button" className="sign-in3-button2 thq-button-outline">
            <span>
              {props.action2 ?? (
                <Fragment>
                  <span className="sign-in3-text19 thq-body-small">
                    Create an account
                  </span>
                </Fragment>
              )}
      ...
      <img
        alt={props.image1Alt}
        src="https://img.freepik.com/free-photo/transport-logistics-concept_23-2151541906.jpg?t=st=1725678625~exp=1725682225~hmac=3c80181f8fc3f8bdc297fe89edc5732dc0b591bf0f571c7f7565528f94acd355&amp;w=826"
